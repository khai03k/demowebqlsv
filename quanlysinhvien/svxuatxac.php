    ...
    <header class="header">
        <div class="container">
            ...
            <ul class="category-list">
                ...
                <li class="category-item">
                    <a href="#" class="category_name">Sinh viên xuất xắc</a>
                </li>
        ...
        <article>
            <div class="box-parent">
                ...
                if (isset($_POST['search_btn'])) {
                    ...
                    $sql_select     = "SELECT tbl_diemhocphan.msv, tbl_diemhocphan.mhp,tbl_diemhocphan.A, tbl_diemhocphan.B, tbl_diemhocphan.C,
                                ...
                                WHERE (tbl_diemhocphan.A + tbl_diemhocphan.B + tbl_diemhocphan.C)/3 >= 8 AND tbl_diemhocphan.msv LIKE '%$search_content%'";
                } else {
                    $sql_select = "SELECT tbl_diemhocphan.msv, tbl_diemhocphan.mhp,tbl_diemhocphan.A, tbl_diemhocphan.B, tbl_diemhocphan.C,
                                tbl_sinhvien.holot, tbl_sinhvien.ten, tbl_sinhvien.mlcn
                                FROM tbl_diemhocphan
                                INNER JOIN tbl_sinhvien ON tbl_diemhocphan.msv = tbl_sinhvien.msv
                                WHERE (tbl_diemhocphan.A + tbl_diemhocphan.B + tbl_diemhocphan.C)/3 >= 8;";
                }
                                ...
                                <tbody>
                                    <?php foreach ($result_select as $row) { ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= number_format(($row['A'] + $row['B'] + $row['C']) / 3, 1) ?>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
