        ...
        <article>
            <div class="box-parent">
                ...
                if (isset($_POST['search_btn'])) {
                    ...
                    $sql_select     = "SELECT * FROM tbl_hocphan WHERE mhp LIKE '%$search_content%'";
                } else {
                    $sql_select = "SELECT * FROM tbl_hocphan";
                }
                    ...
                    <div class="box">
                        ...
                        <div class="body-content">
                            <form action="" method="POST" class="search-content">
                                <span>Mã học phần</span>
                                <input type="text" name="search_content" placeholder="Nhập Mã học phần">
